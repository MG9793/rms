        ...
        <h5 class="fw-bold p-2 text-center">กรุณาเลือกข้อมูล | ภาษีซื้อ</h5>
            ...
            <div class="row">
                <?php
                    ...
                    // query VAT เดือนทั้งหมด
                    $allMonth_vat = $conn->query("SELECT SUM(vat) AS monthVAT FROM bill_head WHERE report = 'N' AND vat <> 0");
                    $allMonth_vat->execute();
                    $all_monthVAT = $allMonth_vat->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="card">
                        <div class="fw-bold text-center border p-2 text-light rounded bg-danger">ยอดรวมที่ไม่ได้เลือก</div>
                            ...
                            <div class="d-flex flex-row justify-content-between mb-5">
                                ...
                                <h3 class="mb-0 fw-bold text-danger"><?php echo number_format($all_monthVAT['monthVAT'], 2); ?></h3>
                            </div>
                        </div>
                    </div>
                    </form>

...
// query ชื่อผู้ใช้งาน
        ...
        // query materialTotal
        $materialTotal = $conn->query("SELECT SUM(sum) as materialSum FROM bill_head where material = 1");
        ...
        // query labourTotal
        $labourTotal = $conn->prepare("SELECT SUM(sum) as labourSum FROM bill_head where labour = 1");
        $labourTotal->execute();
